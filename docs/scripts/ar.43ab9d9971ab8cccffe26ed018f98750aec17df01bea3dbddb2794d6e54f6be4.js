...
(function () {
  ...
  AFRAME.registerComponent("location-item", {
    init: function init() {
      this.el.addEventListener("click", function (e) {
        ...
        popupLink.href = "https://www.google.com/maps?q=" + e.target.attributes.latitude.value + "," + e.target.attributes.longitude.value;
  ...
  window.onload = function () {
    document.querySelector(".location-popup").addEventListener("click", function (e) {
